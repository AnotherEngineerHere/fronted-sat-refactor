...
import { useGetAlertsTypeQuery, useGetRiskLevelQuery, useGetPreconditionsQuery, useGetAutoAlertsOfTaskQuery, useCreateAutoAlertMutation, useUpdateAutoAlertMutation, useDeletAutoAlertMutation, useGetTriggersQuery } from "../../redux/api/mainAPI";
import { useSelector } from "react-redux";
const { Option } = Select;
const operatorData = ["AND", "OR", "NOT"];

const AutomaticAlertView = () =>{
    ...
    console.log(idTask);
    const {data: dataSource,  error: autoErrorReq, autoLoadingReq} = useGetAutoAlertsOfTaskQuery({idTask,userInfo});
...
export default AutomaticAlertView;
